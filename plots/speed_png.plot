...
plot \
    'speed_png-data.txt' index 0 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 1 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 2 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 3 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 4 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 5 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 6 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 7 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 8 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 9 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 10 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 11 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 12 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 13 title "algo=stdsort" with linespoints
...
## GROUP BY MULTIPLOT, x ORDER BY MULTIPLOT, x
plot \
    'speed_png-data.txt' index 14 title "algo=ssssort" with linespoints, \
    'speed_png-data.txt' index 15 title "algo=stdsort" with linespoints
